  ...
  <div class="FinalScreen">
    <div class="conponentContent">
      ...
      <div class="componentText">
        <p class="componentSubline">Your Reaction Time</p>
        <h2 class="componentHeadline">{{ averageReactionTime }} ms</h2>
        <p class="componentSubline">Click anywhere to try again</p>
      </div>
    </div>
  </div>
</template>
